...
# Principal Component Analysis: 20 gives the best accuracy
...
# Runs a single algorithm at a time; based on the selection in the arguments
...
# Prints the accuracy and precision values.
